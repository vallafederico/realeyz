  class Sketch {
    constructor() {
      ...
      this.loadin = {
        ...
        width : document.getElementById('loadingbargrey').offsetWidth,
        unit : document.getElementById('loadingbargrey').offsetWidth / this.videos.length
      }
      gsap.set(this.loadin.bar, {width:0});
      // Dom Slides Handling
    ...
    handleVids() {
      let loadingwrap = document.getElementById('prelw');
      let loadingCount = 0;
      ...
      this.videos.forEach((item, i) => {
        ...
        item.addEventListener('canplaythrough', ()=> {
          ...
          // Preloader Advance Based on Video
