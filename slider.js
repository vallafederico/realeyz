  class Sketch {
    constructor(selector) {
      ...
      // this.s_date = [...document.querySelectorAll('.s_date')];
      // this.s_type = [...document.querySelectorAll('.s_type')];
      // this.s_txt = [...document.querySelectorAll('.s_txt')];
      // this.s_line = [...document.querySelectorAll('.s_line')];
      this.domsplit();
    ...
    domctrls() {
      ...
      this.bt = {
        ...
        reset: document.getElementById('reset'), // 2
        init: document.getElementById('init'), // 3
        prev: document.getElementById('prev'), // 4
        next: document.getElementById('next'), // 5
      };
      let werein = false;
      ...
      // //  RESET
      // this.bt.reset.addEventListener('click', ()=> {
      //   this.group.children.forEach((item, i) => {
      //     gsap.to(item.material.uniforms.introanim, {value:1, duration:.5, ease: "power2.out"})
      //   });
      // })
